...
class IndexRoutes {
    ...
    config() {
        ...
        this.router.get("/listatareas", indexController_1.indexController.lista_tareas);
        this.router.get("/listaeventos", indexController_1.indexController.lista_eventos);
        ...
        this.router.post("/encargadosevento", indexController_1.indexController.encargados_evento);
        this.router.post("/banteam", indexController_1.indexController.ban_team);
        this.router.post("/vaciarevento", indexController_1.indexController.vaciar_evento);
